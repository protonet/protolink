...
class Swanson < Linkbot::Plugin
    def self.on_message(message, matches)
      quotes = [
{:image => "http://www.pajiba.com/image/ron-dancing-animated.gif"},
{:image => "http://28.media.tumblr.com/tumblr_lgl0ieJ0Z01qzkiy8o1_400.jpg"},
{:image => "http://www.randomblog.org/wp-content/uploads/2011/02/Ron-Swanson-Pyramid-e1297006038780.jpg"},
